...
Measure and package tiny audio data URIs and waveform metadata for v1.

## Why this exists

Solana transaction v1 raises the maximum transaction size from 1,232 to 4,096 bytes. Soundbyte SOL explores a focused consumer use of that space while making the wire budget visible.
